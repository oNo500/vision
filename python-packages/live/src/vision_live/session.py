...
class SessionManager:
    ...
    def remove_tts(self, item_id: str) -> bool:
        from vision_live.tts_mutations import remove_by_id
    ...
    def edit_tts(self, item_id: str, new_text: str, new_speech_prompt) -> bool:
        from vision_live.tts_mutations import edit_by_id
    ...
    def reorder_tts(self, stage: str, ids: list[str]) -> bool:
        from vision_live.tts_mutations import reorder_stage
    ...
    def _build_and_start(
        ...
        if active_plan:
            ...
            from vision_live.schema import LiveScript, ScriptSegment
