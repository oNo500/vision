...
from src.live.rag_cli import cmd_build
...
def plan_dirs(tmp_path: Path, monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("src.live.rag_cli.DATA_ROOT", data_root)
    monkeypatch.setattr("src.live.rag_cli.INDEX_ROOT", index_root)
